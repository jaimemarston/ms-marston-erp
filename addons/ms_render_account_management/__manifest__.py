{
    ...
    'data': [
        ...
        'security/views_users/group_vb_jefatura_view/ir.model.access.csv',
        'security/views_users/group_vb_logistica_view/ir.model.access.csv',
        'security/views_users/group_vb_direccion_view/ir.model.access.csv',
